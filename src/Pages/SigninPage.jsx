            ...
            <nav aria-label="breadcrumb ">
              <ol class="breadcrumb d-flex justify-content-center">
                <li class="breadcrumb-item">
                  <a href="/front" class="text-white text-decoration-none">
                    Home
                  </a>
                </li>
                ...
                <div class="card-body pt-0">
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        class="btn bg-c-main text-white rounded-0 "
                        fdprocessedid="n02h2"
                        style={{ marginLeft: "45%" }}
                      >
                        JOIN
